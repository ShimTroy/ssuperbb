...
Revision ID: 9dacda6e54d3
Revises: 
Create Date: 2022-06-05 20:00:06.596009
...
def upgrade():
    ...
    sa.Column('explaination', sa.String(), nullable=False),
    ...
    op.create_table('product_voter',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('product_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['product_id'], ['product.id'], name=op.f('fk_product_voter_product_id_product'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_product_voter_user_id_user'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('user_id', 'product_id', name=op.f('pk_product_voter'))
    )
    ...
    sa.ForeignKeyConstraint(['review_id'], ['review.id'], name=op.f('fk_review_voter_review_id_review'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_review_voter_user_id_user'), ondelete='CASCADE'),
